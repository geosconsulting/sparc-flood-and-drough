...
def fetch_ECMWF_data_manuale(time_frame,dict_area_richiesta):
    ...
    server.retrieve({
        ...
        "stream": "oper",
        "area": area_ecmwf_bbox,
        "target": "0_gribs_from_ecmwf/historical/afr_s24_t12_mar_0111.grib",
        # "time": "00/06/12/18",
        "time": "12",
        "type": "fc",
    })
...
def genera_means_ciclo10(file_path, parte_iso, parte_date,anni):
        ...
        for anno in anni:
            ...
            nome_tiff_cumulata = "1_mean_from_gribs/mar01_mar11/cum_" + parte_iso + "_" + str(indice) + "_" + str(anno)\
                                 + "_" + parte_date + ".tif"
            nome_tiff_average = "1_mean_from_gribs/mar01_mar11/mean_" + parte_iso + "_" + str(indice) + "_" + str(anno)\
                                 + "_" + parte_date + ".tif"
...
# fetch_ECMWF_data_manuale('dates/req_0111_03_19792016.txt', dict)

grib_file = "0_gribs_from_ecmwf/historical/afr_s24_t12_mar_0111.grib"
...
# genera_means_ciclo10(grib_file, "africa", "0111_03_19792015", anni)
