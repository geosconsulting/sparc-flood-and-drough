...
class AppSPARC:
    def __init__(self, finestra):
        ...
        self.button_drought_upload = Button(finestra, text="Upload Data Manually",
                                            fg="maroon", command=self.drought_upload)
        ...
        self.button_landslide_upload = Button(finestra, text="Upload Data Manually",
